...
var src_2 = require("../../../../../list-builder/src");
var ViewModalComponent = function () {
    ...
    var ViewModalComponent = _classThis = /** @class */ (function () {
        function ViewModalComponent_1(swalService, _matDialog, data, minimizeService, translateService, cdRef) {
        ...
        ViewModalComponent_1.prototype.ngAfterViewInit = function () {
            ...
            if (!this.listController) {
                this.listController = new src_2.ListController((_a = this.values) !== null && _a !== void 0 ? _a : this.model, this.modelFacade, this.model);
            }
        ...
        ViewModalComponent_1.prototype.onDismiss = function () {
            var _this = this;
