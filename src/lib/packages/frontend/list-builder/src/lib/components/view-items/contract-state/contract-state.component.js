...
var ContractStateComponent = function () {
    ...
    var ContractStateComponent = _classThis = /** @class */ (function () {
        function ContractStateComponent_1() {
            this.value = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _value_initializers, void 0));
        }
        return ContractStateComponent_1;
    }());
    __setFunctionName(_classThis, "ContractStateComponent");
    (function () {
        ...
        ContractStateComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ContractStateComponent = _classThis;
}();
