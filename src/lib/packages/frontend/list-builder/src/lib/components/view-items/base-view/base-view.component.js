...
var BaseViewComponent = function () {
    ...
    var _listField_decorators;
    var _listField_initializers = [];
    var BaseViewComponent = _classThis = /** @class */ (function () {
        function BaseViewComponent_1(cdRef) {
            ...
            this.listField = __runInitializers(this, _listField_initializers, void 0);
        }
        BaseViewComponent_1.prototype.ngOnInit = function () {
            this._value = this.viewObject[this.fieldName];
        };
        return BaseViewComponent_1;
    }());
    __setFunctionName(_classThis, "BaseViewComponent");
    (function () {
        ...
        _listField_decorators = [(0, core_1.Input)()];
        ...
        __esDecorate(null, null, _listField_decorators, { kind: "field", name: "listField", static: false, private: false, access: { has: function (obj) { return "listField" in obj; }, get: function (obj) { return obj.listField; }, set: function (obj, value) { obj.listField = value; } }, metadata: _metadata }, _listField_initializers, _instanceExtraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        BaseViewComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BaseViewComponent = _classThis;
}();
