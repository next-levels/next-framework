...
export function GenericWebSocketGateway(entity:any,namespace: string, corsOptions: any,event:any): any {
  @WebSocketGateway( {

    namespace: namespace,
    cors: corsOptions,
  })
  class GenericGateway implements OnGatewayConnection, OnGatewayDisconnect, OnGatewayInit {
    @WebSocketServer()
    server: Server;
