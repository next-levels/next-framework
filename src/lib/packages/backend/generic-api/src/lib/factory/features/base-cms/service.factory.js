...
function GenericBaseCMSService(entity) {
    var GenericServiceHost = function () {
        ...
        var GenericServiceHost = _classThis = /** @class */ (function (_super) {
            ...
            function GenericServiceHost_1(repository) {
                var _this = _super.call(this) || this;
                _this.repository = repository;
                return _this;
            }
            GenericServiceHost_1.prototype.create = function (data) {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.saveWithRelations(data)];
                            case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                        }
                    });
                });
            };
            GenericServiceHost_1.prototype.delete = function (id) {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            GenericServiceHost_1.prototype.findAll = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            GenericServiceHost_1.prototype.findByFilter = function (query) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, this._findByFilter(query)];
                    });
                });
            };
            GenericServiceHost_1.prototype._findByFilter = function (query) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                _b = (_a = result_1.Result).ok;
                                return [4 /*yield*/, (0, nestjs_paginate_1.paginate)(query, repo, {
            ...
            GenericServiceHost_1.prototype.findOne = function (id) {
                return Promise.resolve(undefined);
            };
            GenericServiceHost_1.prototype.update = function (id, data) {
                return Promise.resolve(undefined);
            };
            GenericServiceHost_1.prototype.saveWithRelations = function (entity) {
                return __awaiter(this, void 0, void 0, function () {
                    var newEntity, relationFields;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.repository.save(entity)];
                            case 1:
                                newEntity = _a.sent();
                                relationFields = this.repository.metadata.relations.map(function (relation) { return relation.propertyName; });
