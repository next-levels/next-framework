...
var jwt_auth_guard_1 = require("src/lib/packages/backend/nest-commons/src/lib/guards/jwt-auth.guard");
function GenericBaseCMSController(entity, event) {
    ...
    var GenericControllerHost = function () {
        ...
        var _frontendFindOne_decorators;
        var GenericControllerHost = _classThis = /** @class */ (function (_super) {
            ...
            GenericControllerHost_1.prototype.frontendFindAll = function (country) {
            ...
            GenericControllerHost_1.prototype.findByFilter = function (query, req) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.service.findByFilter(query, req.user.userId)];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                });
            };
            GenericControllerHost_1.prototype.create = function (dto) {
                return __awaiter(this, void 0, void 0, function () {
            ...
            GenericControllerHost_1.prototype.remove = function (id) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
            ...
            GenericControllerHost_1.prototype.frontendFindOne = function (id) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
        ...
        (function () {
            ...
            _frontendFindAll_decorators = [(0, common_1.Get)('frontend'), (0, common_1.UseInterceptors)(file_handler_1.FileInjectInterceptor)];
            ...
            _frontendFindOne_decorators = [(0, common_1.Get)(':id'), (0, common_1.UseInterceptors)(file_handler_1.FileInjectInterceptor)];
            ...
            __esDecorate(_classThis, null, _frontendFindOne_decorators, { kind: "method", name: "frontendFindOne", static: false, private: false, access: { has: function (obj) { return "frontendFindOne" in obj; }, get: function (obj) { return obj.frontendFindOne; } }, metadata: _metadata }, null, _instanceExtraInitializers);
...
function GenericBaseCMSControllerCreator(config, event) {
    if (event === void 0) { event = null; }
    var GenericControllerHost = function () {
        var _classDecorators = [(0, common_1.Controller)(config.route + '/admin/'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        var _classDescriptor;
        var _classExtraInitializers = [];
        var _classThis;
        var _classSuper = GenericBaseCMSController(config.entity, event);
        var GenericControllerHost = _classThis = /** @class */ (function (_super) {
