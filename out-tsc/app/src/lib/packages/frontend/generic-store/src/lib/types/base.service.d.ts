...
export interface BaseService<EntityType extends object> {
    ...
    findByFilter(filterOptions: FilterOptions): Observable<EntityPaginated<EntityType>>;
    ...
    updateEntity(entityId: number, changes: Partial<EntityType>): Observable<EntityType>;
}
